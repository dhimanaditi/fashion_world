    ...
    console.log(user)
        ...
        $.ajax({
            ...
            success: (posRes) => {
                ...
                for (let i = 0; i < 6; i++) {                     //gdata.length
                    x = x + `
                    <div class = 'col-4 '>
                        <div class = 'card'>
        ...
        $.ajax({
            ...
            success: (posRes) => {
                gdata = posRes
                let x = '<div class = "row col-12">'
                for (let i = 6; i < 12; i++) {                     //gdata.length
                    x = x + `
                    <div class = 'col-4 '>
                        <div class = 'card'>
                            <img src = ${gdata[i].pic} class = 'card-img-top'>
        ...
        $.ajax({
            ...
            success: (posRes) => {
                gdata = posRes
                let x = '<div class = "row col-12">'
                for (let i =12; i < 18; i++) {                     //gdata.length
                    x = x + `
                    <div class = 'col-4 '>
                        <div class = 'card'>
                            <img src = ${gdata[i].pic} class = 'card-img-top'>
...
function addToCart(id)
{
    ...
    $.ajax({
        ...
        success: (posRes) => {
            ...
            if(cqty == 1)   //if quantity is 1: product is present then update qty of the product. otherwise make entry in cart
            {
                console.log("Present")
                let data = {}
                data.uid = user
